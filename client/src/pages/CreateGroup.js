...
// Define and export the CreateGroup component
...
export default function CreateGroup() {
  ...
  // Effect to update dates when checkboxDates changes
  ...
  // Effects to update dates when group start or end date changes
