...
// Custom hook to force update
const useForceUpdate = () => {
    const [, setValue] = useState(0);
    return () => setValue((value) => ++value);
};
// Exporting the main functional component for managing discussions
export default function Discussion(props) {
    ...
    // Custom hook usage for force update
    const forceUpdate = useForceUpdate();
    // Function components for managing discussion comments and inputs
                        ...
                        <>
                            <div className="inline-block gap-2">
                                <IconButton className=""
                                    onClick={() => {
                                        DeleteDiscussionCommentService(comment._id).then((data) => {
                                            setOpen(true);
    ...
    // Function to handle deleting a discussion post
    ...
    // Function to redirect for creating a discussion post
    const handleCreateDiscussionPost = () => {
        window.location.href = `/createDiscussionPost/${group._id}`
    };
    // useEffect hook to fetch group data and discussion posts by ID
    ...
    // Return statement containing JSX structure for managing discussion posts and comments
